...
class Ui_Temperature(object):
    def setupUi(self, Temperature):
        ...
        Temperature.setStyleSheet(u"QWidget{background:qlineargradient(spread:pad, x1:0.881, y1:0.812682, x2:0.976909, y2:0.164, stop:0 rgba(9, 214, 250, 33), stop:1 rgba(255, 255, 255, 255))}\n"
"")
        self.actionStandar = QAction(Temperature)
        self.actionStandar.setObjectName(u"actionStandar")
        self.actionScientific = QAction(Temperature)
...
"")
        ...
        self.menuFile.addAction(self.actionStandar)
    ...
    def retranslateUi(self, Temperature):
        ...
        self.actionStandar.setText(QCoreApplication.translate("Temperature", u"Standar", None))
        self.actionScientific.setText(QCoreApplication.translate("Temperature", u"Scientific", None))
        ...
        self.btn_clear.setText(QCoreApplication.translate("Temperature", u"CE", None))
        ...
        self.btn_del_one.setText(QCoreApplication.translate("Temperature", u"\u00ab", None))
