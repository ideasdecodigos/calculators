...
class Ui_Length(object):
    def setupUi(self, Length):
        ...
        Length.setStyleSheet(u"QWidget{background:qlineargradient(spread:pad, x1:0.631, y1:0.534, x2:0.675773, y2:0.102273, stop:0 rgba(250, 101, 9, 24), stop:1 rgba(255, 255, 255, 255))}\n"
"")
        self.actionStandar = QAction(Length)
...
"QPushButton{background:transparent}")
        ...
        self.comboBox2.setCurrentIndex(6)
    ...
    def retranslateUi(self, Length):
        Length.setWindowTitle(QCoreApplication.translate("Length", u"Temperature", None))
        self.actionStandar.setText(QCoreApplication.translate("Length", u"Standar", None))
        ...
        self.btn_del_one.setText(QCoreApplication.translate("Length", u"\u00ab", None))
        self.btn_clear.setText(QCoreApplication.translate("Length", u"CE", None))
