...
class Ui_Time(object):
    def setupUi(self, Time):
        ...
        Time.setStyleSheet(u"QWidget{background:qlineargradient(spread:pad, x1:0.221909, y1:1, x2:0.601909, y2:0.119318, stop:0 rgba(102, 241, 73, 29), stop:1 rgba(255, 255, 255, 255))}\n"
"")
        self.actionStandar = QAction(Time)
        self.actionStandar.setObjectName(u"actionStandar")
        self.actionScientific = QAction(Time)
...
"QPushButton{background:transparent}")
    ...
    def retranslateUi(self, Time):
        ...
        self.actionStandar.setText(QCoreApplication.translate("Time", u"Standar", None))
        self.actionScientific.setText(QCoreApplication.translate("Time", u"Scientific", None))
        ...
        self.btn_del_one.setText(QCoreApplication.translate("Time", u"\u00ab", None))
        self.btn_clear.setText(QCoreApplication.translate("Time", u"CE", None))
